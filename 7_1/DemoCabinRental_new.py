...
class CabinRental:
    ...
    def __init__(self,cabinNumber):
        ...
        if (cabinNumber >= 1) and (cabinNumber <= 3):
            self._rentalRate = 950
        else:
            self._rentalRate = 1100
